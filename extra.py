...
def atta(text, attachments):
	...
	for attachment in attachments:
		...
		elif attachment['type'] == 'wall': count += atta('', attachment['wall']['attachments'])
		...
		elif attachment['type'] == 'video': count += round(attachment['video']['duration'] / 2) if attachment['video']['duration'] < 70 * 2 else 70
	return count