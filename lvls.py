...
class LVL(dict, ContextInstanceMixin):
	...
	async def atta(self, text='', attachments=[], id = None, negative = False):
		...
		for attachment in attachments:
			...
			elif attachment.type == 'wall_reply': count += await self.atta(attachment.wall_reply.text, attachment.wall_reply.attachments)
		...
		count = count if not negative else -count
