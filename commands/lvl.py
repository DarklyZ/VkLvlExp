from utils import Data as data, custom_rules, attachmentsT
...
async def info(message):
	exp, errors = await attachmentsT.exp(message.reply_message.text, message.reply_message.attachments, return_errors = True)
